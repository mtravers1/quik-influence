  ...
  return (
    <Stack p={10} bg={cardThemeColor[colorMode]}>
      ...
      <Accordion mt={5} allowMultiple>
        ...
        <AccordionItem border="none">
          {({ isExpanded }) => (
            <Status onChange={handleChange} isExpanded={isExpanded} />
          )}
        </AccordionItem>

        <AccordionItem border="none">
          {({ isExpanded }) => (
            <Age onChange={handleChange} isExpanded={isExpanded} />
          )}
        </AccordionItem>

        <AccordionItem border="none">
          {({ isExpanded }) => (
            <Gender onChange={handleChange} isExpanded={isExpanded} />
          )}
        </AccordionItem>

        <AccordionItem border="none">
          {({ isExpanded }) => (
            <ByApplication onChange={handleChange} isExpanded={isExpanded} />
          )}
        </AccordionItem>
      </Accordion>
