...
const datepickerMethods = {
  getDatepickerWidgetNode: function () {
    return this.datepickerWidgetNode
      ? this.datepickerWidgetNode
      : this.setDatepickerWidgetNode();
  },
  setDatepickerWidgetNode: function () {
    return (this.datepickerWidgetNode = document.getElementById(
      `datepicker-widget__${this.instance_id}`
    ));
  },
  getDatepickerTargetNode: function () {
    return this.datepickerTargetNode
      ? this.datepickerTargetNode
      : this.setDatepickerTargetNode();
  },
  setDatepickerTargetNode: function () {
    return (this.datepickerTargetNode =
      this.selector instanceof Element
        ? this.selector
        : document.querySelector(this.getSelector()));
  },
  ...
  setDatepickerTargetParentNode: function () {
    return (this.datepickerTargetParentNode =
      this.selector instanceof Element
        ...
        : document.querySelector(this.getSelector()).parentElement);
  },
  getdatepickerContainerNode: function () {
    return this.datepickerContainerNode
      ? this.datepickerContainerNode
      : this.setDatepickerContainerNode();
  },
  ...
  attachDatepickerContainerToDOM: function () {
    ...
    this.getDatepickerTargetParentNode().style.setProperty(
      'position',
      'relative'
    );
  ...
  adjustDatepickerPosition: function () {
    ...
    const parentRect =
      this.getDatepickerTargetParentNode().getBoundingClientRect();
    ...
    const left =
      targetRect.left -
      parentRect.left +
      (targetRect.width / 2 - widgetRect.width / 2);
