...
/* harmony import */ var modules_Leads__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7667);
...
const CampaignsLeads = ()=>{
    const { leads  } = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)((state)=>state.campaigns
    );
    ...
    const { 0: loading , 1: setLoading  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(!campaignsLeads);
    const fetchCampaignsLeads = async ()=>{
        setLoading(true);
        dispatch((0,redux_actions_campaigns__WEBPACK_IMPORTED_MODULE_7__/* .getCampaignLeads */ .Mu)(campaignId, page, pageSize));
        setLoading(false);
    };
    ...
    return loading ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_MainContent__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
        ...
        filter: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_LeadsPageFilters__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
            setAllSelectedFilters: ()=>{}
        }),
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(modules_Leads__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CampaignsLeads);
...
var __webpack_exports__ = __webpack_require__.X(0, [7730,1664,5675,8081,3629,3814,2341,6089,3821,9229,4974,4392,1273,7184], () => (__webpack_exec__(9799)));
