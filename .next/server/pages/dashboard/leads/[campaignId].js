...
const CampaignsLeads = ()=>{
    const { leads , loading  } = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)((state)=>state.campaigns
    );
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        dispatch((0,redux_actions_campaigns__WEBPACK_IMPORTED_MODULE_7__/* .getCampaignLeads */ .Mu)(campaignId, page, pageSize, sortBy, {
...
var __webpack_exports__ = __webpack_require__.X(0, [7730,1664,5675,8081,3629,3814,2341,6089,3821,9229,4974,4392,1273,7184], () => (__webpack_exec__(6788)));
