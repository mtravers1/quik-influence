...
const theme = (0,_chakra_ui_react__WEBPACK_IMPORTED_MODULE_0__.extendTheme)({
    ...
    components: {
        ...
        Table: {
            variants: {
                creditsTransactionalTable: (props)=>({
                        table: {
                            bgColor: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)('white', 'black.500')(props)
                        },
                        tr: {
                ...
                leadTable: (props)=>({
                        table: {
                            bgColor: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)('#F5F8F9', 'black.500')(props)
                        },
                        tr: {
                            ...creditsTransactionalTableBorder
                        },
